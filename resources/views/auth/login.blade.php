                        ...
                        <ul class="nav nav-pills nav-fill" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="signin-tab-2" data-toggle="tab" href="#signin-2"
                                    role="tab" aria-controls="signin-2" aria-selected="true">Log In</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="signin-2" role="tabpanel"
                                ...
                                <form action="{{ route('login') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="singin-email-2">Registered Email Id *</label>
                                        <input type="text" class="form-control @error('email') is-invalid @enderror"
                                            id="singin-email-2" name="email" value="{{ old('email') }}" required>
                                        @error('email')
                            ...
                            <div class="tab-pane fade" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                ...
                                <form action="{{ route('registration') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('reg_email') is-invalid @enderror"
                                            id="register-email-2" name="reg_email" value="{{ old('reg_email') }}"
                                            required>
                                        @error('reg_email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-footer">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                class="custom-control-input @error('register-policy') is-invalid @enderror"
                                                id="register-policy-2" name="register-policy" required>
                                            <label class="custom-control-label" for="register-policy-2">I agree
                                                to the <a href="#">privacy policy</a> *</label>
                                            @error('register-policy')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
